...
const VALID_MASK_SHAPES: readonly string[] = ["rectangle", "circle", "square", "rounded"];
...
export function loadUserPreferences(): UserPreferences {
	...
	return {
		...
		webcamMaskShape:
			typeof raw.webcamMaskShape === "string" && VALID_MASK_SHAPES.includes(raw.webcamMaskShape)
				? (raw.webcamMaskShape as WebcamMaskShape)
